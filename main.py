...
## test 5 bar
Robot.animationik(0.01,0.005,5,np.array([[4.714],[0.5257]]),np.array([[2.832],[6.825]]),'d','up',0.01,0.01)
plt.show()

## test 4 bar
# Robot.animationik(0.01,0.005,5,np.array([[2.088],[3.895]]),np.array([[0.3273],[2.976]]),'d','up',0.01,0.01)
# plt.show()
